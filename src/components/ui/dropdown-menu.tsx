...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Trigger
    ref={ref}
    className={cn("dropdown-neon-snake", className)}
    {...props}
  />
));
...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      "data-[state=open]:bg-gradient-to-r data-[state=open]:from-primary/15 data-[state=open]:to-accent/10",
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ...
    className={cn(
      ...
      "transition-all duration-200 ease-out",
      "data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      "focus:bg-gradient-to-r focus:from-primary/15 focus:to-accent/10 focus:text-accent-foreground",
      className,
    )}
    checked={checked}
    {...props}
