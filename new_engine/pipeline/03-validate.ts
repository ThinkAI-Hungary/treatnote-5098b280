...
import { GLOBAL_DEFAULTS } from '../catalog/defaults.js';
import { getToothRegion } from '../shared/tooth-utils.js';
import type { ProtocolInstance, AtomicActionInstance } from '../shared/types.js';
