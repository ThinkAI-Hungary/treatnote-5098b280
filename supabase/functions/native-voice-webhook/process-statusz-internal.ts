...
export async function processVoxisInternally(jobId: string, audioBuffer: File | null, supabaseAdmin: any, apiKeys: any, context: any, overrideTranscript?: string) {
  ...
  try {
    ...
    const quadrantConfig = [
      { key: "q1", num: 1, positions: [1,2,3,4,5,6,7,8] },
      { key: "q2", num: 2, positions: [1,2,3,4,5,6,7,8] },
      { key: "q3", num: 3, positions: [1,2,3,4,5,6,7,8] },
